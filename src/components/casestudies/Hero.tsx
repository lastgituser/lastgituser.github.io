    ...
    return (
        <section className={"h-[calc(100vh-6rem)] flex justify-center w-full bg-casestudy-" + props.mockup + "-light dark:bg-casestudy-" + props.mockup + "-dark"}>
            <div className={heroClasses}>
                <div className="z-0 text-center align-middle text-primary dark:text-secondary text-[3.5rem] sm:text-display font-display font-bold bg-secondary dark:bg-primary px-8 py-4 rounded-[2rem] bg-opacity-80 col-span-2">{props.title}</div>
